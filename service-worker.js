...
const APP_CACHE = `${CACHE_PREFIX}app-v17`;
...
const APP_SHELL = [
  ...
  "./app/app.js?v=17",
  "./app/controllers.js?v=17",
  "./app/file-types.js",
  "./app/repository.js",
  "./app/timestamp.js",
  "./app/whisper-transcriber.js?v=17",
  "./app/whisper-worker.js?v=17",
  "./app/moonshine-v2-worker.js?v=17",
  "./app/model-cache.js?v=17",
];
...
self.addEventListener("fetch", (event) => {
  ...
  // Transcription model files use their dedicated cache, avoiding a second
  // large model copy in this service worker cache.
