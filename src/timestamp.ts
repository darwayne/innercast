...
export function validateOffset(offset: number, duration: number): number {
...
export function sourceTimeForMicTime(offset: number, micTime: number): number {
  return offset + micTime;
}
