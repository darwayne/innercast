export type WhisperModelKey = "tiny" | "base" | "small" | "medium" | "moonshineTiny" | "moonshineBase" | "moonshineSmallStreaming" | "moonshineMediumStreaming";
...
export class OnDeviceWhisperTranscriber {
  ...
  async transcribe(
    ...
    return new Promise((resolve, reject) => {
      ...
      const workerFile = model.family === "moonshine-v2" ? "../app/moonshine-v2-worker.js?v=14" : "../app/whisper-worker.js?v=14";
